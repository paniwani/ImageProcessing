...
{	
	...
	IteratorTypeFloat4WithIndex input2_iter(input2,region);
	...
	for (input2_iter.GoToBegin(); !input2_iter.IsAtEnd(); ++input2_iter)
	{
	...
	{
		if (colon_iter.Get() == 1 && input2_iter.Get() >= 200+abs(min))
		{
	...
	input2_iter = IteratorTypeFloat4WithIndex(input2,region);
