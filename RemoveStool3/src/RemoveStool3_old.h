...
//New functions
VoxelTypeImage::Pointer OptimizeVoxelEdge(ImageType::Pointer input, IteratorTypeFloat4WithIndex inputIt, VoxelTypeImage::Pointer voxel_type, IteratorTypeVoxelType voxelEdgeIt );
