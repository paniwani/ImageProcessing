/*=========================================================================
 ...
 =========================================================================*/
#ifndef __otbScalarImageToTexturesMaskFilter_h
#define __otbScalarImageToTexturesMaskFilter_h
...
namespace otb
{
/** \class ScalarImageToTexturesMaskFilter
...
class ScalarImageToTexturesMaskFilter : public itk::ImageToImageFilter
  <TInpuImage, TOutputImage>
{
public:
  /** Standard class typedefs */
  typedef ScalarImageToTexturesMaskFilter                       Self;
  ...
  /** RTTI */
  itkTypeMacro(ScalarImageToTexturesMaskFilter, ImageToImageFilter);
...
private:
  ScalarImageToTexturesMaskFilter(const Self&); //purposely not implemented
...
#include "otbScalarImageToTexturesMaskFilter.txx"
#endif
