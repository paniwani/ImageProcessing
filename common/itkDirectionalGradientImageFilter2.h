#ifndef __itkDirectionalGradientImageFilter2_h
#define __itkDirectionalGradientImageFilter2_h
...
namespace itk {
/**
 * \class DirectionalGradientImageFilter2
...
class ITK_EXPORT DirectionalGradientImageFilter2 :
    public ImageToImageFilter<TInputImage, TOutputImage>
{
public:
  /** Standard class typedefs. */
  typedef DirectionalGradientImageFilter2         Self;
  ...
  itkTypeMacro(DirectionalGradientImageFilter2, ImageToImageFilter);
...
private:
  ...
  typedef typename itk::GradientImageFilter<InputImageType>  GaussGradFiltType;
...
#include "itkDirectionalGradientImageFilter2.txx"
#endif
