/*=========================================================================
  ...
  Module:    $RCSfile: itkGreyLevelCooccurrenceMatrixTextureCoefficientsCalculator.txx,v $
  Language:  C++
...
NormalizeHistogram( void )
{
  ...
  {
	m_Histogram->SetFrequency( bin, m_Histogram->GetFrequency(bin) / totalFrequency);
  }
}
                          ...
                          double &marginalDevSquared, double &pixelVariance )
{
  ...
  HistogramIterator hit(m_Histogram);
