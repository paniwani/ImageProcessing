...
=========================================================================*/
#ifndef __itkCannyEdgeDetectionImageFilterModified_h
#define __itkCannyEdgeDetectionImageFilterModified_h
...
/** \class CannyEdgeDetectionImageFilterModified
 *
...
class ITK_EXPORT CannyEdgeDetectionImageFilterModified
  : public ImageToImageFilter<TInputImage, TOutputImage>
{
public:
  /** Standard "Self" & Superclass typedef.  */
  typedef CannyEdgeDetectionImageFilterModified                 Self;
  ...
  itkTypeMacro(CannyEdgeDetectionImageFilterModified, ImageToImageFilter);
  ...
  /** CannyEdgeDetectionImageFilterModified needs a larger input requested
   * region than the output requested region ( derivative operators, etc).  
   * As such, CannyEdgeDetectionImageFilterModified needs to provide an implementation
...
protected:
  CannyEdgeDetectionImageFilterModified();
  CannyEdgeDetectionImageFilterModified(const Self&) {}
...
private:
  virtual ~CannyEdgeDetectionImageFilterModified(){};

  /** Thread-Data Structure   */
  struct CannyThreadStruct
    {
    CannyEdgeDetectionImageFilterModified *Filter;
    };
...
#include "itkCannyEdgeDetectionImageFilterModified.txx"
#endif
