/*=========================================================================
  ...
  Module:    $RCSfile: itkScalarImageToCooccurrenceMatrixFilter2.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkScalarImageToCooccurrenceMatrixFilter2_h
#define __itkScalarImageToCooccurrenceMatrixFilter2_h
...
/** \class ScalarImageToCooccurrenceMatrixFilter2 
 ...
 * 
 * \sa MaskedScalarImageToCooccurrenceMatrixFilter2
...
class ITK_EXPORT ScalarImageToCooccurrenceMatrixFilter2 : public ProcessObject
{
public:
  /** Standard typedefs */
  typedef ScalarImageToCooccurrenceMatrixFilter2               Self;
  typedef ProcessObject                                       Superclass;
  typedef SmartPointer<Self>                                  Pointer;
  typedef SmartPointer<const Self>                            ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(ScalarImageToCooccurrenceMatrixFilter2, ProcessObject);
  ...
  itkSetMacro( LocalRegion, typename ImageType::RegionType );
  itkGetConstMacro( LocalRegion, typename ImageType::RegionType );
  


protected:
  ScalarImageToCooccurrenceMatrixFilter2();
  virtual ~ScalarImageToCooccurrenceMatrixFilter2() {};
...
private:
  ScalarImageToCooccurrenceMatrixFilter2(const Self&); //purposely not implemented
  ...
  typename ImageType::RegionType m_LocalRegion;
...
#include "itkScalarImageToCooccurrenceMatrixFilter2.txx"
#endif
