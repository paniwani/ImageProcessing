/*=========================================================================
  ...
  Module:    $RCSfile: itkScalarImageToCooccurrenceMatrixFilter2.txx,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkScalarImageToCooccurrenceMatrixFilter2_txx
#define __itkScalarImageToCooccurrenceMatrixFilter2_txx
...
ScalarImageToCooccurrenceMatrixFilter2< TImageType,
...
template< class TImageType, class THistogramFrequencyContainer >
const typename ScalarImageToCooccurrenceMatrixFilter2< TImageType,
...
template< class TImageType, class THistogramFrequencyContainer >
typename ScalarImageToCooccurrenceMatrixFilter2< TImageType,
...
GenerateData( void )
{
  ...
  if ( maskImage != NULL )
    {  
    this->FillHistogramWithMask(radius, m_LocalRegion, maskImage );
    }
  else
    {
    this->FillHistogram(radius, m_LocalRegion );
    }
