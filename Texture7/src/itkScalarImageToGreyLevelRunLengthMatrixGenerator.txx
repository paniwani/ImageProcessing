...
ScalarImageToGreyLevelRunLengthMatrixGenerator<TImageType, THistogramFrequencyContainer>
...
template<class TImageType, class THistogramFrequencyContainer>
const typename ScalarImageToGreyLevelRunLengthMatrixGenerator<TImageType,
...
template<class TImageType, class THistogramFrequencyContainer>
typename ScalarImageToGreyLevelRunLengthMatrixGenerator<TImageType,
