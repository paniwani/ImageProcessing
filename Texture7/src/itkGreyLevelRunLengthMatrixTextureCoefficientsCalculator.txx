...
template<class THistogram>
const typename
GreyLevelRunLengthMatrixTextureCoefficientsCalculator<THistogram>::HistogramType *
GreyLevelRunLengthMatrixTextureCoefficientsCalculator< THistogram>
::GetInput() const
{
...
template<class THistogram>
typename
GreyLevelRunLengthMatrixTextureCoefficientsCalculator<THistogram>::DataObjectPointer
GreyLevelRunLengthMatrixTextureCoefficientsCalculator<THistogram>
...
GenerateData( void )
{
  ...
  std::cout << this->m_TotalNumberOfRuns << std::endl;
...
template<class THistogram>
const
typename GreyLevelRunLengthMatrixTextureCoefficientsCalculator<THistogram>::MeasurementObjectType*
GreyLevelRunLengthMatrixTextureCoefficientsCalculator<THistogram>
...
template<class THistogram>
typename GreyLevelRunLengthMatrixTextureCoefficientsCalculator<THistogram>::MeasurementType
GreyLevelRunLengthMatrixTextureCoefficientsCalculator<THistogram>
