...
class ScalarImageToGreyLevelRunLengthMatrixGenerator : public ProcessObject
{
public:
  /** Standard typedefs */
...
private:
  ScalarImageToGreyLevelRunLengthMatrixGenerator(const Self&); //purposely not implemented
